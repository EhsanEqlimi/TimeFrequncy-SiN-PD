...
BaseLineNormtype='db';
Norm=1;
SelChanSwitch=1; %only desired channels;
...
if 1
    ...
    %topoplot
    Type='GrandAvg Induced Power PreSent';
    FnTopoPlotPower(GrandAvg_InducedPowerS14_PreSent,EEGChanLoc,0,2,Type);
    title(['-5dB-Induced Power PreSent'   '-[' num2str(TimeRange_PreSent_Ind(1)) '-'...
        num2str(TimeRange_PreSent_Ind(2)) '] sec-[' num2str(8) '-' num2str(12) '] Hz']);
    
    
    Type='GrandAvg Induced Power DuringSent';
    FnTopoPlotPower(GrandAvg_InducedPowerS14_DuringSent,EEGChanLoc,-3,3,Type);
    ...
    Type='GrandAvg Induced Power PostSent';
    FnTopoPlotPower(GrandAvg_InducedPowerS14_PostSent,EEGChanLoc,0,1,Type);
