function [freq,meanVals] = ft_freqbaseline_EE(cfg, freq)
...
for k = 1:numel(cfg.parameter)
  ...
  if strcmp(freq.dimord, 'chan_freq_time')
    ...
    [freqOut.(par),meanVals] = performNormalization(freq.time, freq.(par), cfg.baseline, cfg.baselinetype);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [data ,meanVals]= performNormalization(timeVec, data, baseline, baselinetype)
